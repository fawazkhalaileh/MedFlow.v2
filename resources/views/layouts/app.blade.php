    ...
    <nav class="sidebar-nav">
      ...
      <div class="sidebar-section">
        ...
        <a href="{{ route('employees.index') }}" class="sidebar-item {{ request()->routeIs('employees.*') ? 'active' : '' }}">
          ...
          Employees
          <span class="sidebar-badge">{{ \App\Models\User::whereNotNull('company_id')->count() }}</span>
        </a>
      </div>
      ...
      <div class="sidebar-section">
        ...
        <a href="{{ route('appointments.index') }}" class="sidebar-item {{ request()->routeIs('appointments.*') ? 'active' : '' }}">
          ...
          Appointments
          <span class="sidebar-badge">{{ \App\Models\Appointment::whereDate('scheduled_at', today())->count() }}</span>
        </a>
      </div>
